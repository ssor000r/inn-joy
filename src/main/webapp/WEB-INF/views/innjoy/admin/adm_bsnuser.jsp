	...
	<div id="layoutSidenav_content">
		<main>
			<div class="container" class="container-fluid px-4">
				<h1 class="mt-4">사업자 회원 목록</h1>
				<ol class="breadcrumb mb-4">
					<li class="breadcrumb-item">사업자회원관리</a></li>
					<li class="breadcrumb-item active">사업자 회원 목록</li>
				</ol>
				<div class="card mb-4">
					<div class="card-body">전체 사업자 회원을 조회, 메일링 및 탈퇴 처리할 수 있습니다.</div>
				</div>
				<div class="card mb-4">
							...
							<tbody>
								<c:forEach var="bsnuser" items="${bsnList}">
									<tr>
										...
										<td>${bsnuser.ceo_name}</td>
										<td>${bsnuser.bsn_phone}</td>
										<td><a
											href="${path}/admin/bsnuser_mailForm?bsn_id=${bsnuser.bsn_id}">${bsnuser.bsn_email}
										</a></td>
										<td><input type="button" class="adminBan" value="탈퇴"
											name="삭제" onclick="userBan('${bsnuser.bsn_id}')" /></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
