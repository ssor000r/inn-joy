		...
		<main>
			<div class="container-fluid px-4"
				...
				<ol class="breadcrumb mb-4">
					...
					<li class="breadcrumb-item active">일반 회원 탈퇴 처리</li>
				</ol>
				<div class="card mb-4">
					<div class="card-body">신고된 회원에 대하여 탈퇴처리를 진행할 수 있습니다.</div>
				</div>
				<div class="card mb-4">
					<div class="card-header">
						<i class="fas fa-table me-1"></i> 일반 회원 신고 목록
					</div>
					<div class="card-body">
								...
								<c:forEach var="ijuser" items="${userList}">
									<tr >
										...
										<input type="button" class="adminBan" value="탈퇴" name="삭제"
											onclick="userBan('${ijuser.user_id}')"/>
										</td>
									</tr>
								</c:forEach>
							</tbody>
	...
	<script type="text/javascript">
		function userBan(id) {
			if(confirm("아이디 : "+id+" 을 탈퇴처리 하시겠습니까?")){
				location.href = "${path}/userBan?user_id=" + id
		    }
		}
	</script>
	<script
