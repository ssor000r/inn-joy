                              ...
                              <div class="section-center">
                                 <div class="row">
                                    <div class="booking-form">
                                       <form action="product_detail_all" method="get" name="regForm">
                                          ...
                                          <c:forEach var="room" items="${proDetail}">
                                             <div class="room-item">
                                                ...
                                                <div class="room-info">
                                                   ...
                                                   <button class="select-room-btn" onclick="window.location.href='${path}/login'">객실 선택</button>
                           ...
                           <c:forEach var="board" items="${blist}">
                              <form id="commForm">
                                 ...
                                 <div class="recommendation">
                                    <img
                                       src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMzA3MThfMjE1%2FMDAxNjg5NjgyMjkyNjEy.qh04MF1RCBnjzl9YXLIzp6W3xbD9thiVZSpfH9_UO2gg.XN6FKZzrYnEzvxB8vDN-noqQZbY4f-Lr03vXINiLJsog.JPEG.kkan9000%2FKakaoTalk_20230718_193348736_06.jpg&type=sc960_832"
                                 ...
                                 <div class="wejoy-comment-section">
                                    <div class="wejoy-comment">
                                       <span class="wejoy-user-nickname">${board.user_id}</span>
